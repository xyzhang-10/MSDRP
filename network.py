...
class MSDRP(nn.Module):
    def __init__(self, drugs_dim, cells_dim,embed_dim, bathsize, dropout1, dropout2):
        ...
        self.drug_dim = self.drugs_dim//13
    ...
    def forward(self, drug_features, cell_features, device,fused_network):
        ...
        drug1, drug2, drug3, drug4, drug5, drug6, drug7, drug8, drug9, drug10, drug11, drug12, drug13= drug_features.chunk(13, 1)
        ...
        x_drug13 = F.relu(self.drug13_bn(self.drug_layer13(drug13.float().to(device))), inplace=True)
        x_drug13 = F.dropout(x_drug13, training=self.training, p=self.dropout1)
        x_drug13 = self.drug_layer13_1(x_drug13)




        drugs = [x_drug1, x_drug2, x_drug3, x_drug4, x_drug5, x_drug6, x_drug7, x_drug8, x_drug9, x_drug10, x_drug11, x_drug12, x_drug13]
