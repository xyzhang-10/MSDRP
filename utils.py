...
def read_raw_data(rawdata_dir):
    ...
    gii = open(rawdata_dir + 'drug/' + 'SNF_smiles_drug_gene.pkl', 'rb')
    ...
    drug_ic_sim = Chebyshev_Distance(ic)
    ...
    cell_features.append(exp)
    cell_features.append(mu)
    cell_features.append(cn)
    cell_features.append(cell_ic_sim)
